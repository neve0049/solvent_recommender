...
def show_home_page():
    ...
    st.image("https://via.placeholder.com/1200x400?text=Quaterco+Scientific+Analysis+Platform", use_column_width=True)
    
    st.markdown("""
    ### Fonctionnalités principales :
    - **KD Database Explorer** : Explorez la base de données des coefficients de partage
    - **Diagrammes de phase ternaires** : Visualisez et analysez les systèmes à 3 composants
    - **Diagrammes de phase quaternaires** : Visualisez et analysez les systèmes à 4 composants
    - **Paramètres de solubilité de Hansen** : Analysez les paramètres HSP des composés
    - **Diagrammes ternaires COSMO-RS** : Importez et traitez les données COSMO-RS
    - **Diagrammes quaternaires COSMO-RS** : Importez et traitez les données COSMO-RS pour 4 composants
    """)
